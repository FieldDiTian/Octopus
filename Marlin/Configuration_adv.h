...
#define HOMING_BUMP_MM      { 5, 5, 2, 5, 5, 5, 5, 5, 5 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 4, 2, 2, 2, 2, 2, 2 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       900        // (mA) RMS current. Adjust to suit the connected stepper
    ...
    #define Y_CURRENT       900        // (mA) Adjust to suit the connected stepper
    ...
    #define Z_CURRENT       900        // (mA) Adjust to suit the connected stepper
    ...
    #define E0_CURRENT      900        // (mA) Adjust to suit the connected stepper
